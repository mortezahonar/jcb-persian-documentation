...
| **ترکیب و استفاده مجدد ویوی سایت** | طراحی لایه‌های عمومی با ترکیب یک Dynamic Get اصلی با قالب‌ها، لایه‌ها، پلیس هولدرهای کد سفارشی و کتابخانه‌های اختیاری JS/CSS؛ سپس مدیریت به‌روزرسانی‌ها از طریق بازنشانی یا فورک. | [افزودن ویوهای سایت](./Adding-Site-Views-to-a-Component.md), [افزودن قالب‌ها و لایه‌ها](./Adding-Templates-and-Layouts-to-a-Site-View.md), [لایه‌های JCB](./JCB-Layouts.md), [dynamicGet](./dynamicGet.md) |
...
لایه‌ها، Dynamic Get‌ها، کتابخانه‌های اختیاری JavaScript/CSS و پلیس هولدرهای کد سفارشی قابل‌استفاده مجدد را ترکیب کنید تا تجربه‌های جلا یافته ادمین و فرانت‌اند بسازید که مدل داده شما را آینه می‌کنند. وقتی نیاز به هم‌گام‌سازی با مخازن مشترک یا حفظ سفارشی‌سازی‌های بلندمدت دارید، ویوهای سایت را بازنشانی یا فورک کنید.
