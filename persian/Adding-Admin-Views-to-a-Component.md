...
1. در JCB، **کامپوننت** خود را باز کنید (برای مثال، *Sermon Distributor*).
2. به **Settings → Admin Views** بروید.
   اینجا جایی است که ویوهای ادمین موجود خود را به کامپوننت متصل می‌کنید.
3. روی دکمه **Add** کلیک کنید، سپس یک **ویوی ادمین** را از منوی کشویی انتخاب کنید.
4. این فرآیند را برای هر ویویی که می‌خواهید متصل کنید تکرار کنید.
...
* ابزار JCB از **فونت‌های استاندارد Icomoon جوملا** برای این آیکون‌ها استفاده می‌کند.
...
ابزار JCB سوئیچ‌هایی در اختیار شما قرار می‌دهد تا کنترل کنید هر ویو چگونه در منوی ادمین کامپوننت شما ظاهر شود.
...
1. **Keep History** را در ویوی ادمین فعال کنید.
2. یک آیتم را ویرایش کنید (مثلاً "Preacher → A Capella Music").
3. روی **Versions** در نوار ابزار بالا کلیک کنید.
4. شما می‌توانید:
...
کامپوننت JCB می‌تواند به‌صورت خودکار قابلیت **واردات/صادرات** را به هر ویوی ادمین اضافه کند.

* گزینه **Export/Import Data** را روی "بله" قرار دهید تا فعال شود.
...
1. سوئیچ **Edit Create Site View** را در تنظیمات ویوی ادمین خود فعال کنید.
2. پس از کامپایل:

   * ابزار JCB یک نسخه **ویوی سایت** از فرم ادمین شما تولید می‌کند.
...
**مهم:**
کامپوننت JCB کد فرانت‌اند را تولید می‌کند اما به‌صورت خودکار لینک‌های منو ایجاد نمی‌کند.
